<?php
    ...
    {
        $array[0] = addslashes($_POST['name']);
        $array[1] = addslashes($_POST['birthday']);
        $array[2] = addslashes($_POST['gender']);
        $array[3] = addslashes($_POST['city']);
        $array[4] = addslashes($_POST['address']);
        $array[5] = addslashes($_POST['mail']);
        $array[6] = addslashes($_POST['phone']);
        $result= $connection->insertforData($array);
    }  
?>
...
<body>
    ...
    <form name="myForm" action="addnew.php" onsubmit="return validateForm()" method="post">
        <div class="container">
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-sm-3" id="box1">
                    ...
                    <input type="email" class="form-control" name="mail" id="mail" placeholder="nguyen123@gmail.com" >
                </div>
                <div class="form-group col-sm-3" id="box2">
        ...
        <div class="outer">
            ...
            <div id="box3">
                <button type="submit" name="return" style="border:none; padding:0px"><a href="select.php" class="btn btn-primary">Return</a></button>
            </div>
        </div>
    </form>
</body>
